                ...
                <div class="signin_wthree">
                    <form method="post" action="login.do">
                        <div class="group">
                            ...
                            <input id="user" type="text" class="input" name="username" value="" required>
                        </div>
                        <div class="group">
                            <label for="pass" class="label">Password</label>
                            <input id="pass" type="password" class="input" name="password" value="" data-type="password" required>
                        </div>
